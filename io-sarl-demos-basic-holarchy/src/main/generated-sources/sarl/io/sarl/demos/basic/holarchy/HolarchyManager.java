...
public class HolarchyManager extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_API_CORE_LIFECYCLE$CALLER.spawn(Holon.class);
    Logging _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER = this.$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER();
    _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER.setLoggingName("Holarchy Manager");
  }

  private void $behaviorUnit$HolarchyDestroyed$1(final HolarchyDestroyed occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER = this.$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER();
  ...
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$HolarchyDestroyed(final HolarchyDestroyed occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$HolarchyDestroyed$1(occurrence));
  }
  ...
  public void $getSupportedEvents(final Set<Class<? extends Event>> toBeFilled) {
    ...
    toBeFilled.add(HolarchyDestroyed.class);
  }
  ...
  public boolean $isSupportedEvent(final Class<? extends Event> event) {
    ...
    if (HolarchyDestroyed.class.isAssignableFrom(event)) {
      return true;
    }
    return false;
  }
  ...
  public void $evaluateBehaviorGuards(final Object event, final Collection<Runnable> callbacks) {
    ...
    if (event instanceof HolarchyDestroyed) {
      final HolarchyDestroyed occurrence = (HolarchyDestroyed) event;
      $guardEvaluator$HolarchyDestroyed(occurrence, callbacks);
    }
  }

  @SyntheticMember
  public HolarchyManager(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }

  @SyntheticMember
  @Inject
  public HolarchyManager(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
